...
- Add consuming best-effort structured API error details while retaining the original response
  error and body through `Error::body()` for unrecognized or malformed responses.
